...
puts "The name of your Hamster is #{hamsters_name}, he squeeks at the volume of #{hamsters_loud},  this hamsters fur is #{hamsters_fur}, is the hamster good for adoption? #{hamsters_adoption}, the hamsters age is #{hamsters_age}"